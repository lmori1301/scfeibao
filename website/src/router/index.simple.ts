...
const routes: RouteRecordRaw[] = [
  { path: '/', name: 'Home', component: () => import('@/views/Frame12.vue') },
  ...
  { path: '/Vector11982', name: 'Vector11982', component: () => import('@/views/Vector11982.vue') },
  { path: '/Frame1466', name: 'Frame1466', component: () => import('@/views/Frame1466.vue') },
  { path: '/Frame11280', name: 'Frame11280', component: () => import('@/views/Frame11280.vue') },
  ...
  { path: '/Frame11053', name: 'Frame11053', component: () => import('@/views/Frame11053.vue') },
  ...
  { path: '/Frame12', name: 'Frame12', component: () => import('@/views/Frame12.vue') }
]

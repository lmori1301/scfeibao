<template>
    <div ref="scrollContainerRef" class="scroll-container-1_1494">
        <div id="1_1494" ref="frameRef" class="Pixso-frame-1_1494">
            <div id="1_1495" class="Pixso-vector-1_1495"></div>
            <div id="1_1496" class="Pixso-vector-1_1496"></div>
            <div id="1_1499" class="Pixso-vector-1_1499"></div>
            <p id="1_1502" class="Pixso-paragraph-1_1502">
                {{ "四川飞豹救援" }}
            </p>
            <p id="1_1503" class="Pixso-paragraph-1_1503">
            ...
            <router-link to="/overview-info" id="1_1525" class="Pixso-paragraph-1_1525 main-nav-link" active-class="" exact-active-class="">概况信息</router-link>
            <router-link to="/team-building" id="1_1526" class="Pixso-paragraph-1_1526 main-nav-link" active-class="" exact-active-class="">队伍建设</router-link>
            <router-link to="/party-building" id="1_1531" class="Pixso-paragraph-1_1531 main-nav-link" active-class="" exact-active-class="">党建专栏</router-link>
            <router-link to="/info-public" id="1_1527" class="Pixso-paragraph-1_1527 main-nav-link" active-class="" exact-active-class="">信息公开</router-link>
            <router-link to="/dynamic-news" id="1_1528" class="Pixso-paragraph-1_1528 main-nav-link" active-class="" exact-active-class="">动态要闻</router-link>
            <router-link to="/policy-regulations" id="1_1529" class="Pixso-paragraph-1_1529 main-nav-link" active-class="" exact-active-class="">政策法规</router-link>
            <router-link to="/query-system" id="1_1530" class="Pixso-paragraph-1_1530 main-nav-link" active-class="" exact-active-class="">查询系统</router-link>
            ...
            <template v-if="paginatedMembers.length > 0">
                ...
                <p v-if="paginatedMembers[0]" id="1_1567" class="Pixso-paragraph-1_1567" @click="goToDetail(paginatedMembers[0].id)" style="cursor: pointer;">{{ paginatedMembers[0].title }}</p>
                ...
                <p v-if="paginatedMembers[1]" id="1_1568" class="Pixso-paragraph-1_1568" @click="goToDetail(paginatedMembers[1].id)" style="cursor: pointer;">{{ paginatedMembers[1].title }}</p>
                ...
                <p v-if="paginatedMembers[2]" id="1_1569" class="Pixso-paragraph-1_1569" @click="goToDetail(paginatedMembers[2].id)" style="cursor: pointer;">{{ paginatedMembers[2].title }}</p>
                ...
                <p v-if="paginatedMembers[3]" id="1_1570" class="Pixso-paragraph-1_1570" @click="goToDetail(paginatedMembers[3].id)" style="cursor: pointer;">{{ paginatedMembers[3].title }}</p>
...
.Pixso-vector-1_1496 {
    width: 100%;
    height: 10.25%;
    background-image: url(@/assets/images/Vector_1_1496.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_1499 {
    width: 6.72%;
    height: 6.82%;
    background-image: url(@/assets/images/Vector_1_1499.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.46%;
...
.Pixso-vector-1_1512 {
    width: 100%;
    height: 3.7%;
    background-image: url(@/assets/images/Vector_1_1512.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_1513 {
    width: 10.62%;
    height: 3.7%;
    background-image: url(@/assets/images/Vector_1_1513.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 34.95%;
...
.Pixso-vector-17_9 {
    width: 150px;
    height: 70px;
    background-image: url(@/assets/images/Group_17_9.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 113px;
...
.Pixso-vector-1_1545 {
    width: 46.25%;
    height: 13.74%;
    background-image: url(@/assets/images/Vector_1_1545.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.23%;
...
.Pixso-vector-1_1546 {
    width: 46.25%;
    height: 13.74%;
    background-image: url(@/assets/images/Vector_1_1546.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.23%;
...
.Pixso-vector-1_1547 {
    width: 46.25%;
    height: 13.74%;
    background-image: url(@/assets/images/Vector_1_1547.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.23%;
...
.Pixso-vector-1_1548 {
    width: 46.25%;
    height: 13.74%;
    background-image: url(@/assets/images/Vector_1_1548.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.23%;
...
.Pixso-vector-1_1549 {
    width: 0%;
    height: 6.5%;
    background-image: url(@/assets/images/Vector_1_1549.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.43%;
...
.Pixso-vector-1_1554 {
    width: 0%;
    height: 6.5%;
    background-image: url(@/assets/images/Vector_1_1554.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.43%;
...
.Pixso-vector-1_1557 {
    width: 0%;
    height: 6.5%;
    background-image: url(@/assets/images/Vector_1_1557.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.43%;
...
.Pixso-vector-1_1560 {
    width: 0%;
    height: 6.5%;
    background-image: url(@/assets/images/Vector_1_1560.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.43%;
...
.Pixso-vector-1_1647 {
    width: 18.38%;
    height: 8.61%;
    background-image: url(@/assets/images/Vector_1_1647.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_1648 {
    width: 18.38%;
    height: 6.07%;
    background-image: url(@/assets/images/Vector_1_1648.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_1649 {
    width: 18.38%;
    height: 6.08%;
    background-image: url(@/assets/images/Vector_1_1649.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_1655 {
    width: 18.38%;
    height: 6.08%;
    background-image: url(@/assets/images/Vector_1_1655.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_1657 {
    width: 18.38%;
    height: 6.08%;
    background-image: url(@/assets/images/Vector_1_1657.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_1659 {
    width: 0.2%;
    height: 1.21%;
    background-image: url(@/assets/images/Vector_1_1659.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 8.07%;
...
.Pixso-vector-1_1660 {
    width: 2.13%;
    height: 2.22%;
    background-image: url(@/assets/images/Boolean_operation_1_1660.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 7.92%;
...
.Pixso-vector-33_184 {
    width: 100%;
    height: 42px;
    background-image: url(@/assets/images/Vector_33_184.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-33_186 {
    width: 7.39%;
    height: 25px;
    background-image: url(@/assets/images/Group_33_186.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 85.21%;
...
.Pixso-vector-34_5 {
    width: 87.37%;
    height: 100%;
    background-image: url(@/assets/images/Vector_34_5.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 12.63%;

<template>
    <div ref="scrollContainerRef" class="scroll-container-1_876">
        <div id="1_876" ref="frameRef" class="Pixso-frame-1_876">
            <div id="1_877" class="Pixso-vector-1_877"></div>
            <div id="1_878" class="Pixso-vector-1_878"></div>
            <div id="1_881" class="Pixso-vector-1_881"></div>
            <p id="1_884" class="Pixso-paragraph-1_884">{{ "四川飞豹救援" }}</p>
            <p id="1_885" class="Pixso-paragraph-1_885">
            ...
            <div id="1_909" class="Pixso-vector-1_909"></div>
            ...
            <router-link id="1_923" to="/party-building" class="Pixso-paragraph-1_923 main-nav-link" active-class="" exact-active-class="">党建专栏</router-link>
            <router-link id="1_928" to="/overview-info" class="Pixso-paragraph-1_928 main-nav-link" active-class="" exact-active-class="">概况信息</router-link>
            <router-link id="1_929" to="/team-building" class="Pixso-paragraph-1_929 main-nav-link" active-class="" exact-active-class="">队伍建设</router-link>
            <router-link id="1_924" to="/info-public" class="Pixso-paragraph-1_924 main-nav-link" active-class="" exact-active-class="">信息公开</router-link>
            <router-link id="1_925" to="/dynamic-news" class="Pixso-paragraph-1_925 main-nav-link" active-class="" exact-active-class="">动态要闻</router-link>
            <router-link id="1_926" to="/policy-regulations" class="Pixso-paragraph-1_926 main-nav-link" active-class="" exact-active-class="">政策法规</router-link>
            <router-link id="1_927_query" to="/query-system" class="Pixso-paragraph-1_927 main-nav-link" active-class="" exact-active-class="">查询系统</router-link>
...
const { scrollContainerRef, frameRef } = usePixsoScale(1920, 1879)
...
.Pixso-vector-1_878 {
    width: 100%;
    height: 10.32%;
    background-image: url(@/assets/images/Vector_1_878.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_881 {
    width: 6.72%;
    height: 6.86%;
    background-image: url(@/assets/images/Vector_1_881.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.46%;
...
.Pixso-vector-1_908 {
    width: 18.39%;
    height: 8.68%;
    background-image: url(@/assets/images/Vector_1_908.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.57%;
...
.Pixso-vector-1_909 {
    width: 18.39%;
    height: 6.12%;
    background-image: url(@/assets/images/Vector_1_909.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.57%;
...
.Pixso-vector-1_910 {
    width: 18.39%;
    height: 37.2%;
    background-image: url(@/assets/images/Vector_1_910.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.57%;
...
.Pixso-vector-1_914 {
    width: 18.39%;
    height: 6.12%;
    background-image: url(@/assets/images/Vector_1_914.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.57%;
...
.Pixso-vector-1_917 {
    width: 100%;
    height: 3.73%;
    background-image: url(@/assets/images/Vector_1_917.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_918 {
    width: 10.63%;
    height: 3.73%;
    background-image: url(@/assets/images/Vector_1_918.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 24.32%;
...
.Pixso-vector-17_3 {
    width: 150px;
    height: 70px;
    background-image: url(@/assets/images/Group_17_3.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 113px;
...
.Pixso-vector-1_930 {
    width: 18.39%;
    height: 6.12%;
    background-image: url(@/assets/images/Vector_1_930.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.57%;
...
.Pixso-vector-1_1024 {
    width: 46.25%;
    height: 13.84%;
    background-image: url(@/assets/images/Vector_1_1024.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 47.97%;
...
.Pixso-vector-1_1025 {
    width: 46.25%;
    height: 13.83%;
    background-image: url(@/assets/images/Vector_1_1025.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 47.97%;
...
.Pixso-vector-1_1026 {
    width: 46.25%;
    height: 13.84%;
    background-image: url(@/assets/images/Vector_1_1026.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 47.97%;
...
.Pixso-vector-1_1030 {
    width: 0%;
    height: 6.55%;
    background-image: url(@/assets/images/Vector_1_1030.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.17%;
...
.Pixso-vector-1_1033 {
    width: 0%;
    height: 6.54%;
    background-image: url(@/assets/images/Vector_1_1033.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.17%;
...
.Pixso-vector-1_1036 {
    width: 0%;
    height: 6.54%;
    background-image: url(@/assets/images/Vector_1_1036.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 54.17%;
...
.Pixso-vector-1_1047 {
    width: 2.14%;
    height: 2.24%;
    background-image: url(@/assets/images/Boolean_operation_1_1047.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 7.29%;
...
.Pixso-vector-6_399 {
    width: 87.37%;
    height: 100%;
    background-image: url(@/assets/images/Vector_6_399.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 12.63%;
...
.Pixso-vector-33_139 {
    width: 100%;
    height: 42px;
    background-image: url(@/assets/images/Vector_33_139.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-33_141 {
    width: 7.39%;
    height: 25px;
    background-image: url(@/assets/images/Group_33_141.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 85.21%;

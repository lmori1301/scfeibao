<template>
    <div class="scroll-container-1_562">
        <div id="1_562" class="Pixso-frame-1_562">
            ...
            <div v-show="activeIndex === 0" id="1_607" class="Pixso-vector-1_607" style="width: 6.51%;"></div>
            ...
            <div v-show="activeIndex === 1" class="Pixso-vector-1_607 unit-underline-1" style="left: 65.94%; width: 5.26%;"></div>
            ...
            <div v-show="activeIndex === 4" class="Pixso-vector-1_607 unit-underline-4" style="left: 73.02%; width: 9.12%;"></div>
            ...
            <div v-show="activeIndex === 5" class="Pixso-vector-1_607 unit-underline-5" style="left: 83.96%; width: 6.51%;"></div>

<template>
    <div class="scroll-container-1_2250">
        <div id="1_2250" class="Pixso-frame-1_2250">
            ...
            <p id="1_2258" class="Pixso-paragraph-1_2258">{{ "四川飞豹救援" }}</p>
            <p id="1_2259" class="Pixso-paragraph-1_2259">
                {{ "Sichuan Feibao Rescue" }}
            </p>
            <div id="1_2268" class="Pixso-vector-1_2268"></div>
            ...
            <p id="1_2282" class="Pixso-paragraph-1_2282">
                当前位置：<router-link to="/" class="policy-breadcrumb-link">首页</router-link> > <router-link to="/policy-regulations" class="policy-breadcrumb-link">政策法规</router-link> > <span class="policy-breadcrumb-current">部门规章</span>
            </p>
            ...
            <p id="1_2379" class="Pixso-paragraph-1_2379">{{ "部门规章" }}</p>
            ...
            <p id="1_2383" class="Pixso-paragraph-1_2383">{{ "部门规章" }}</p>
            ...
            <router-link to="/policy-regulations/laws" id="1_2391" class="Pixso-paragraph-1_2391 policy-nav-link">法律法规</router-link>
            <router-link to="/policy-regulations/regulations" id="1_2392" class="Pixso-paragraph-1_2392 policy-nav-link">
                部门规章                          >
            </router-link>
            <div id="1_2394" class="Pixso-vector-1_2394"></div>
            <router-link to="/policy-regulations/standards" id="1_2393" class="Pixso-paragraph-1_2393 policy-nav-link">行业标准</router-link>
            <div id="1_2394" class="Pixso-vector-1_2394"></div>
            <div id="1_2400" class="Pixso-vector-1_2400"></div>
            <div id="33_201" class="Pixso-group-33_201" @click.stop>
            <div id="33_202" class="Pixso-vector-33_202"></div>
            <!-- 输入框 -->
            <input
                v-model="searchKey"
...
.policy-nav-link.router-link-exact-active {
    font-weight: 600;
    position: relative;
    z-index: 10;
}

.policy-nav-link.router-link-exact-active::before {
    content: '';
    position: absolute;
    left: -10px;
    top: -8px;
    bottom: -8px;
    width: 120px;
    background-color: rgba(21, 112, 206, 0.4);
    border-left: 4px solid #FF8C00;
    z-index: -1;
    border-radius: 2px;
}

.policy-breadcrumb-link {
    color: #848484;
    text-decoration: none;
}

.policy-breadcrumb-link:hover {
    color: #848484;
    opacity: 0.9;
}

.policy-breadcrumb-link:active,
.policy-breadcrumb-link:visited {
...
.Pixso-vector-1_2251 {
    width: 100%;
    height: 100%;
    background-image: url(@/assets/images/Vector_1_2251.png);
...
.Pixso-vector-1_2252 {
    width: 100%;
    height: 11.61%;
    background-image: url(@/assets/images/Vector_1_2252.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_2255 {
    width: 6.72%;
    height: 7.72%;
    background-image: url(@/assets/images/Vector_1_2255.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.46%;
...
.Pixso-vector-1_2268 {
    width: 100%;
    height: 4.19%;
    background-image: url(@/assets/images/Vector_1_2268.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-17_11 {
    width: 150px;
    height: 70px;
    background-image: url(@/assets/images/Group_17_11.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 113px;
...
.Pixso-vector-1_2273 {
    width: 100%;
    height: 16.76%;
    background-image: url(@/assets/images/Vector_1_2273.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_2284 {
    width: 87.37%;
    height: 100%;
    background-image: url(@/assets/images/Vector_1_2284.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 12.63%;
...
.Pixso-vector-1_2360 {
    width: 68.33%;
    height: 16.69%;
    background-image: url(@/assets/images/Vector_1_2360.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 26.2%;
...
.Pixso-vector-1_2361 {
    width: 68.33%;
    height: 16.7%;
    background-image: url(@/assets/images/Vector_1_2361.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 26.2%;
...
.Pixso-vector-1_2362 {
    width: 68.33%;
    height: 16.7%;
    background-image: url(@/assets/images/Vector_1_2362.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 26.2%;
...
.Pixso-vector-1_2372 {
    width: 5.63%;
    height: 2.16%;
    background-image: url(@/assets/images/Vector_1_2372.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 28.85%;
...
.Pixso-vector-1_2374 {
    width: 5.63%;
    height: 2.15%;
    background-image: url(@/assets/images/Vector_1_2374.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 28.85%;
...
.Pixso-vector-1_2376 {
    width: 5.63%;
    height: 2.15%;
    background-image: url(@/assets/images/Vector_1_2376.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 28.85%;
...
.Pixso-vector-1_2378 {
    width: 5.63%;
    height: 2.1%;
    background-image: url(@/assets/images/Vector_1_2378.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 87.08%;
...
.Pixso-vector-1_2380 {
    width: 5.63%;
    height: 2.1%;
    background-image: url(@/assets/images/Vector_1_2380.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 87.08%;
...
.Pixso-vector-1_2382 {
    width: 5.63%;
    height: 2.09%;
    background-image: url(@/assets/images/Vector_1_2382.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 87.08%;
...
.Pixso-vector-1_2384 {
    width: 18.38%;
    height: 9.75%;
    background-image: url(@/assets/images/Vector_1_2384.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_2385 {
    width: 18.38%;
    height: 6.88%;
    background-image: url(@/assets/images/Vector_1_2385.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_2386 {
    width: 18.38%;
    height: 6.89%;
    background-image: url(@/assets/images/Vector_1_2386.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-vector-1_2387 {
    width: 18.38%;
    height: 6.88%;
    background-image: url(@/assets/images/Vector_1_2387.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.94%;
...
.Pixso-paragraph-1_2391.policy-nav-active {
    font-weight: 700;
    position: relative;
    z-index: 10;
}
.Pixso-paragraph-1_2391.policy-nav-active::before {
    content: '';
    position: absolute;
    left: -10px;
    top: -8px;
...
.Pixso-paragraph-1_2392.policy-nav-active {
    font-weight: 700;
    position: relative;
    z-index: 10;
}
.Pixso-paragraph-1_2392.policy-nav-active::before {
    content: '';
    position: absolute;
    left: -10px;
    top: -8px;
...
.Pixso-paragraph-1_2393.policy-nav-active {
    font-weight: 700;
    position: relative;
    z-index: 10;
}
.Pixso-paragraph-1_2393.policy-nav-active::before {
    content: '';
    position: absolute;
    left: -10px;
    top: -8px;
...
.Pixso-vector-1_2400 {
    width: 2.14%;
    height: 2.52%;
    background-image: url(@/assets/images/Boolean_operation_1_2400.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 8.07%;
...
.Pixso-vector-33_202 {
    width: 100%;
    height: 42px;
    background-image: url(@/assets/images/Vector_33_202.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-33_204 {
    width: 7.39%;
    height: 25px;
    background-image: url(@/assets/images/Group_33_204.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 85.21%;
...
.Pixso-vector-33_530 {
    width: 10.63%;
    height: 4.19%;
    background-image: url(@/assets/images/Vector_33_530.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 66.61%;

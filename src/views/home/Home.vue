<template>
    <div class="scroll-container-1_2">
        <div id="1_2" class="Pixso-frame-1_2">
            ...
            <div id="1_4" class="Pixso-vector-1_4"></div>
            ...
            <div id="1_31" class="Pixso-vector-1_31"></div>
            <div id="1_32" class="Pixso-vector-1_32"></div>
            <p id="1_35" class="Pixso-paragraph-1_35">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_36" class="Pixso-paragraph-1_36">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_37" class="Pixso-paragraph-1_37">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_38" class="Pixso-paragraph-1_38">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_39" class="Pixso-paragraph-1_39">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_40" class="Pixso-paragraph-1_40">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_41" class="Pixso-paragraph-1_41">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_42" class="Pixso-paragraph-1_42">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_43" class="Pixso-paragraph-1_43">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_44" class="Pixso-paragraph-1_44">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <p id="1_45" class="Pixso-paragraph-1_45">
                {{
                    "四川飞豹救援成都、乐山、崇州、双流支队队伍授旗授牌仪式在成都举行"
                }}
            </p>
            <div id="1_46" class="Pixso-text-1_46">
            ...
            <div id="1_47" class="Pixso-text-1_47">
            ...
            <div id="1_48" class="Pixso-text-1_48">
            ...
            <p id="1_49" class="Pixso-paragraph-1_49">{{ "更多 >>" }}</p>
            <p id="32_1" class="Pixso-paragraph-32_1">{{ "更多 >>" }}</p>
            <div id="1_51" class="Pixso-text-1_51">
            ...
            <div id="1_52" class="Pixso-text-1_52">
            ...
            <div id="1_53" class="Pixso-text-1_53">
            ...
            <div id="1_54" class="Pixso-text-1_54">
            ...
            <div id="1_55" class="Pixso-text-1_55">
            ...
            <div id="1_56" class="Pixso-text-1_56">
            ...
            <div id="1_58" class="Pixso-vector-1_58"></div>
            <div id="1_59" class="Pixso-vector-1_59"></div>
            <div id="1_61" class="Pixso-vector-1_61"></div>
            <div id="1_62" class="Pixso-vector-1_62"></div>
            <div id="1_63" class="Pixso-vector-1_63"></div>
            <div id="1_64" class="Pixso-vector-1_64"></div>
            ...
            <div id="1_91" class="Pixso-vector-1_91"></div>
            <div id="1_92" class="Pixso-vector-1_92"></div>
            <div id="1_93" class="Pixso-vector-1_93"></div>
            <div id="1_94" class="Pixso-vector-1_94"></div>
            <div id="1_95" class="Pixso-vector-1_95"></div>
            <div id="1_96" class="Pixso-vector-1_96"></div>
            <div id="1_97" class="Pixso-vector-1_97"></div>
            <div id="1_98" class="Pixso-vector-1_98"></div>
            <div id="1_102" class="Pixso-vector-1_102"></div>
            <div id="1_103" class="Pixso-vector-1_103"></div>
            <div id="1_104" class="Pixso-vector-1_104"></div>
            <div id="1_105" class="Pixso-vector-1_105"></div>
            ...
            <div id="1_116" class="Pixso-vector-1_116"></div>
            <p id="1_117" class="Pixso-paragraph-1_117">
                {{ "燃爆！四川飞豹救援形象片" }}
            </p>
            ...
            <p id="1_134" class="Pixso-paragraph-1_134">
                {{ "四川省防灾减灾教育馆" }}
            </p>
            ...
            <p id="1_137" class="Pixso-paragraph-1_137">
                {{ "四川省社会力量应急救援队" }}
            </p>
            <p id="1_138" class="Pixso-paragraph-1_138">
                {{ "国家矿山安全监察局" }}
            </p>
            <p id="1_139" class="Pixso-paragraph-1_139">
                {{ "四川省减灾中心" }}
            </p>
            <p id="1_140" class="Pixso-paragraph-1_140">
                {{ "中国地震台网中心" }}
            </p>
            <p id="1_141" class="Pixso-paragraph-1_141">{{ "应急管理部" }}</p>
            <p id="1_142" class="Pixso-paragraph-1_142">
                {{ "国家安全生产应急救援中心" }}
            </p>
            <p id="1_143" class="Pixso-paragraph-1_143">
                {{ "四川省人民政府" }}
            </p>
            <p id="1_144" class="Pixso-paragraph-1_144">
                {{ "四川省应急管理厅" }}
            </p>
            <p id="1_145" class="Pixso-paragraph-1_145">{{ "四川省地震局" }}</p>
            <div id="1_146" class="Pixso-vector-1_146"></div>
            <p id="1_149" class="Pixso-paragraph-1_149">
                {{ "即刻出征，使命必达" }}
            </p>
            <p id="1_150" class="Pixso-paragraph-1_150">
                {{ "Deploy Now, Mission Accomplished" }}
            </p>
            <div id="1_153" class="Pixso-vector-1_153"></div>
            <div id="1_154" class="Pixso-vector-1_154"></div>
            <div id="1_155" class="Pixso-vector-1_155"></div>
            <div id="1_156" class="Pixso-vector-1_156"></div>
            <div id="1_157" class="Pixso-vector-1_157"></div>
            <div id="1_158" class="Pixso-vector-1_158"></div>
            <div id="1_159" class="Pixso-vector-1_159"></div>
            <div id="1_160" class="Pixso-vector-1_160"></div>
            <p id="1_161" class="Pixso-paragraph-1_161">{{ "动态要闻" }}</p>
            <div id="1_162" class="Pixso-vector-1_162"></div>
            <p id="1_163" class="Pixso-paragraph-1_163">{{ "各地动态" }}</p>
            <div id="1_164" class="Pixso-vector-1_164"></div>
            <p id="1_165" class="Pixso-paragraph-1_165">{{ "相关链接" }}</p>
            ...
            <p id="1_169" class="Pixso-paragraph-1_169">{{ "概况信息" }}</p>
            <p id="1_170" class="Pixso-paragraph-1_170">{{ "队伍建设" }}</p>
            <p id="1_171" class="Pixso-paragraph-1_171">{{ "党建专栏" }}</p>
            <p id="1_172" class="Pixso-paragraph-1_172">{{ "信息公开" }}</p>
            <p id="1_173" class="Pixso-paragraph-1_173">{{ "动态要闻" }}</p>
            <p id="1_174" class="Pixso-paragraph-1_174">{{ "政策法规" }}</p>
            <p id="1_175" class="Pixso-paragraph-1_175">{{ "查询系统" }}</p>
            <div id="1_176" class="Pixso-vector-1_176"></div>
            <div id="32_6" class="Pixso-group-32_6">
                <p id="32_4" class="Pixso-paragraph-32_4">{{ "MORE >" }}</p>
                <div id="32_5" class="stroke-wrapper-32_5">
                    <div class="Pixso-rectangle-32_5"></div>
                    <div class="stroke-32_5"></div>
                </div>
            </div>
            <div id="34_1" class="Pixso-group-34_1">
                <p id="34_2" class="Pixso-paragraph-34_2">{{ "MORE >" }}</p>
                <div id="34_3" class="stroke-wrapper-34_3">
                    <div class="Pixso-rectangle-34_3"></div>
                    <div class="stroke-34_3"></div>
                </div>
            </div>
        </div>
    </div>
...
.Pixso-vector-1_4 {
    width: 88.28%;
    height: 14.68%;
    background-image: url(@/assets/images/Vector_1_4.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.89%;
...
.Pixso-vector-1_10 {
    width: 6.72%;
    height: 2.99%;
    background-image: url(@/assets/images/Vector_1_10.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.46%;
...
.Pixso-vector-1_17 {
    width: 1.86%;
    height: 0.83%;
    background-image: url(@/assets/images/Vector_1_17.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 89.48%;
...
.Pixso-vector-1_15 {
    width: 100%;
    height: 42px;
    background-image: url(@/assets/images/Vector_1_15.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 0%;
...
.Pixso-vector-1_18 {
    width: 7.39%;
    height: 25px;
    background-image: url(@/assets/images/Group_1_18.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 85.21%;
...
.Pixso-vector-1_61 {
    width: 1.3%;
    height: 0.58%;
    background-image: url(@/assets/images/Vector_1_61.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 83.75%;
...
.Pixso-vector-1_62 {
    width: 1.31%;
    height: 0.58%;
    background-image: url(@/assets/images/Vector_1_62.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 86.09%;
...
.Pixso-vector-1_63 {
    width: 1.3%;
    height: 0.58%;
    background-image: url(@/assets/images/Vector_1_63.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 88.44%;
...
.Pixso-vector-1_64 {
    width: 1.3%;
    height: 0.58%;
    background-image: url(@/assets/images/Vector_1_64.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 90.78%;
...
.Pixso-vector-1_74 {
    width: 3.02%;
    height: 1.18%;
    background-image: url(@/assets/images/Vector_1_74.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 7.55%;
...
.Pixso-vector-1_89 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_89.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 11.88%;
...
.Pixso-vector-1_90 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_90.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_91 {
    width: 0.06%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_91.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 11.74%;
...
.Pixso-vector-1_92 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_92.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_93 {
    width: 0.05%;
    height: 1.03%;
    background-image: url(@/assets/images/Vector_1_93.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_94 {
    width: 0.06%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_94.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 11.74%;
...
.Pixso-vector-1_95 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_95.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_96 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_96.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_97 {
    width: 0.06%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_97.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 11.74%;
...
.Pixso-vector-1_98 {
    width: 0.05%;
    height: 1.02%;
    background-image: url(@/assets/images/Vector_1_98.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 63.57%;
...
.Pixso-vector-1_102 {
    width: 35.1%;
    height: 0.02%;
    background-image: url(@/assets/images/Vector_1_102.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 59.01%;
...
.Pixso-vector-1_103 {
    width: 35.31%;
    height: 0.02%;
    background-image: url(@/assets/images/Vector_1_103.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.98%;
...
.Pixso-vector-1_104 {
    width: 35.1%;
    height: 0.02%;
    background-image: url(@/assets/images/Vector_1_104.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 59.01%;
...
.Pixso-vector-1_105 {
    width: 35.1%;
    height: 0.03%;
    background-image: url(@/assets/images/Vector_1_105.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 59.01%;
...
.Pixso-vector-1_106 {
    width: 35.31%;
    height: 0.02%;
    background-image: url(@/assets/images/Vector_1_106.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 6.98%;
...
.Pixso-vector-1_107 {
    width: 35.1%;
    height: 0.02%;
    background-image: url(@/assets/images/Vector_1_107.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 59.01%;
...
.Pixso-vector-1_116 {
    width: 6.24%;
    height: 2.78%;
    background-image: url(@/assets/images/Vector_1_116.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 46.88%;
...
.Pixso-vector-1_122 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_122.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 20.26%;
...
.Pixso-vector-1_123 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_123.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 20.26%;
...
.Pixso-vector-1_124 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_124.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.99%;
...
.Pixso-vector-1_125 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_125.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 5.89%;
...
.Pixso-vector-1_126 {
    width: 12.87%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_126.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 34.58%;
...
.Pixso-vector-1_127 {
    width: 12.87%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_127.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 34.58%;
...
.Pixso-vector-1_128 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_128.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.96%;
...
.Pixso-vector-1_129 {
    width: 12.86%;
    height: 2.23%;
    background-image: url(@/assets/images/Vector_1_129.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 48.96%;
...
.Pixso-vector-1_130 {
    width: 247px;
    height: 2.22%;
    background-image: url(@/assets/images/Vector_1_130.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 50%;
...
.Pixso-vector-1_131 {
    width: 247px;
    height: 2.22%;
    background-image: url(@/assets/images/Vector_1_131.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 50%;
...
.Pixso-vector-1_132 {
    width: 315px;
    height: 2.22%;
    background-image: url(@/assets/images/Vector_1_132.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 50%;
...
.Pixso-vector-1_133 {
    width: 315px;
    height: 2.22%;
    background-image: url(@/assets/images/Vector_1_133.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 50%;
...
.Pixso-vector-1_154 {
    width: 0.93%;
    height: 0.41%;
    background-image: url(@/assets/images/Vector_1_154.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 71.88%;
...
.Pixso-vector-1_155 {
    width: 0.94%;
    height: 0.41%;
    background-image: url(@/assets/images/Vector_1_155.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 73.54%;
...
.Pixso-vector-1_156 {
    width: 0.94%;
    height: 0.41%;
    background-image: url(@/assets/images/Vector_1_156.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 75.21%;
...
.Pixso-vector-1_157 {
    width: 0.93%;
    height: 0.41%;
    background-image: url(@/assets/images/Vector_1_157.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 76.88%;
...
.Pixso-vector-1_176 {
    width: 6.25%;
    height: 2.78%;
    background-image: url(@/assets/images/Vector_1_176.png);
    background-size: 100% 100%;
    background-repeat: no-repeat;
    position: absolute;
    left: 46.82%;

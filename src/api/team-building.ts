...
export function getTeamAbout() {
  return http.get<TeamInfo>('/api/team/about')
}
...
export function getRescueCases(params: RescueCaseListParams) {
  return http.get<RescueCaseListResponse>('/api/team/cases', { params })
}
...
export function getRescueCaseDetail(id: number) {
  return http.get<RescueCase>(`/api/team/case/${id}`)
}
...
export function getTeamShowcaseList(params: TeamShowcaseListParams) {
  return http.get<TeamShowcaseListResponse>('/api/team/showcase', { params })
}

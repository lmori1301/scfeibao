...
export function queryCertificate(params: CertificateQueryParams) {
  return http.post<CertificateListItem[]>('/api/query/certificate', params)
}
...
export function getCertificateDetail(certificateNo: string) {
  return http.get<CertificateDetail>(`/api/query/certificate/${certificateNo}`)
}
...
export function queryPersonnel(params: PersonnelQueryParams) {
  return http.post<PersonnelInfo[]>('/api/query/personnel', params)
}
...
export function queryVehicle(params: VehicleQueryParams) {
  return http.post<VehicleInfo[]>('/api/query/vehicle', params)
}
